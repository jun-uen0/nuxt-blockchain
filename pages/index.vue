    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <p class="mt-3 text-gray-600">
          ...
          ※ブラウザにMetaMaskが必要です。
          「契約書に数字を入力」に好きな数字を入力してください。数字の大きさはなんでも構いません。仮想通貨の残高とは関係がありません。ただ、「数字」の情報をブロックチェーン上に記載するだけです。
        </p>
        <p>
          <input
          type="text"
        ...
        <p class="mt-3 text-gray-600">
          ...
          「契約書から数字を受け取る」(契約書から数字を受け取る)をクリックしてください。
          先ほど設定した数字を確認できます。
        </p>
        <p>
          <button
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          ...
          昨今巨大IT企業のデータ独占が問題に叫ばれていますが、ブロックチェーン技術を活用すればデータを参加者全員で管理・所有することができます。全員が管理者・監視者となることでデータの改竄・削除を防ぎます。<br/>
        </p>
        <a href="https://note.com/jun__note/n/n4a7c89e6c36a">【考察】メタバースで描く理想郷 | ブロックチェーンと資本主義社会の再構築</a>
      </div>
